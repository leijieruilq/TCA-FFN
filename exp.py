...
parser.add_argument('--model_name', type=str, default='tcaffn', help='model name: gw,stgcn,agcrn,dcrnn,astgcn,linear,autoformer'+
                                                            'timesnet,dlinear,informer,transformer,arima,lstm,fdnet,cat-ptnet,tcaffn'+
                                                            'pathformer,timemixer,patchtst,frets,lightts,itransformer,fedformer')
parser.add_argument('--dataset_name', type=str, default='weather', help='dataset name: ett(h1,h2,m1,m2), metr_la, pems_bay, pems04, pems08, taxibj13 (13-16)'+
...
parser.add_argument('--device', type=str, default='cuda:0', help='cpu, cuda. cuda:0-n')
